...
const index = require('./index-87ea969e.js');
const form = require('./form-1398d7a0.js');
const guid = require('./guid-c15e3062.js');
const interactive = require('./interactive-5ba8516a.js');
const key = require('./key-2c57c89b.js');
const label = require('./label-75f6d1ae.js');
const loadable = require('./loadable-43262b0c.js');
const locale$1 = require('./locale-1975c3e6.js');
const focusTrapComponent = require('./focusTrapComponent-e6c10d8e.js');
const math = require('./math-46f2df97.js');
const t9n = require('./t9n-d7a704d1.js');
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
  ["ar", () => Promise.resolve().then(function () { return require('./ar-97976ac7.js'); })],
  ["bg", () => Promise.resolve().then(function () { return require('./bg-4746b592.js'); })],
  ["bs", () => Promise.resolve().then(function () { return require('./bs-4666e5f6.js'); })],
  ["ca", () => Promise.resolve().then(function () { return require('./ca-d4192420.js'); })],
  ["cs", () => Promise.resolve().then(function () { return require('./cs-ae3a7243.js'); })],
  ["da", () => Promise.resolve().then(function () { return require('./da-cbc17c28.js'); })],
  ["de", () => Promise.resolve().then(function () { return require('./de-522a0cc6.js'); })],
  ["de-at", () => Promise.resolve().then(function () { return require('./de-at-62e039d2.js'); })],
  ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-abd81f24.js'); })],
  ["el", () => Promise.resolve().then(function () { return require('./el-74aaa2d5.js'); })],
  ["en", () => Promise.resolve().then(function () { return en$1; })],
  ["en-au", () => Promise.resolve().then(function () { return require('./en-au-3dc4b8f2.js'); })],
  ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-50b6caa0.js'); })],
  ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-520d2783.js'); })],
  ["es", () => Promise.resolve().then(function () { return require('./es-a9564b6c.js'); })],
  ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-c184b261.js'); })],
  ["et", () => Promise.resolve().then(function () { return require('./et-56117848.js'); })],
  ["fi", () => Promise.resolve().then(function () { return require('./fi-5582d366.js'); })],
  ["fr", () => Promise.resolve().then(function () { return require('./fr-a9d96fce.js'); })],
  ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-5f0d3354.js'); })],
  ["he", () => Promise.resolve().then(function () { return require('./he-c2a00064.js'); })],
  ["hi", () => Promise.resolve().then(function () { return require('./hi-572b66b6.js'); })],
  ["hr", () => Promise.resolve().then(function () { return require('./hr-af1039ab.js'); })],
  ["hu", () => Promise.resolve().then(function () { return require('./hu-011ab7e9.js'); })],
  ["id", () => Promise.resolve().then(function () { return require('./id-e8ddc09a.js'); })],
  ["it", () => Promise.resolve().then(function () { return require('./it-04b79e75.js'); })],
  ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-6abde76d.js'); })],
  ["ja", () => Promise.resolve().then(function () { return require('./ja-58b6932f.js'); })],
  ["ko", () => Promise.resolve().then(function () { return require('./ko-98251438.js'); })],
  ["lt", () => Promise.resolve().then(function () { return require('./lt-01ad1f2e.js'); })],
  ["lv", () => Promise.resolve().then(function () { return require('./lv-a74983d6.js'); })],
  ["mk", () => Promise.resolve().then(function () { return require('./mk-9b70e9b2.js'); })],
  ["nl", () => Promise.resolve().then(function () { return require('./nl-9d6c092b.js'); })],
  ["nb", () => Promise.resolve().then(function () { return require('./nb-08bd6e17.js'); })],
  ["pl", () => Promise.resolve().then(function () { return require('./pl-1a742e77.js'); })],
  ["pt", () => Promise.resolve().then(function () { return require('./pt-8c16c923.js'); })],
  ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-effec1e7.js'); })],
  ["ro", () => Promise.resolve().then(function () { return require('./ro-49a54585.js'); })],
  ["ru", () => Promise.resolve().then(function () { return require('./ru-4ee656a9.js'); })],
  ["sk", () => Promise.resolve().then(function () { return require('./sk-1781afbe.js'); })],
  ["sl", () => Promise.resolve().then(function () { return require('./sl-cb33fdea.js'); })],
  ["sr", () => Promise.resolve().then(function () { return require('./sr-b12ace5f.js'); })],
  ["sv", () => Promise.resolve().then(function () { return require('./sv-71bf1d6a.js'); })],
  ["th", () => Promise.resolve().then(function () { return require('./th-62937fc7.js'); })],
  ["tr", () => Promise.resolve().then(function () { return require('./tr-04848974.js'); })],
  ["uk", () => Promise.resolve().then(function () { return require('./uk-746aa2ff.js'); })],
  ["vi", () => Promise.resolve().then(function () { return require('./vi-1fa91d12.js'); })],
  ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-85711a52.js'); })],
  ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-94db032e.js'); })],
  ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-da6c531a.js'); })],
]);
